        ...
        <div className="bg-slate-900 flex items-center justify-center aspect-[3/4] relative">
          {hasImage ? (
            <img
              ...
              className="w-full h-full object-contain cursor-zoom-in hover:scale-[1.02] transition-transform duration-300 ease-in-out"
              loading="lazy"
              decoding="async"
            />
          ) : (
            <div className="flex flex-col items-center justify-center p-8 text-center">
              <div className="bg-slate-800/50 p-6 rounded-full mb-4">
                <ImageOff className="w-10 h-10 text-slate-500" strokeWidth={1.5} />
              </div>
              <h3 className="text-lg font-medium text-slate-300 mb-1">No Image Available</h3>
